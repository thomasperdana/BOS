...
const ProfileCard: React.FC<ProfileCardProps> = ({ minimal = false }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
      <div className="bg-blue-600 h-24 relative"></div>
      <div className="px-6 pb-6">
        <div className="flex justify-between items-start -mt-12 mb-4">
          <div className="relative">
            {profile.avatar ? (
              ...
              <div className="w-24 h-24 rounded-full bg-blue-500 flex items-center justify-center text-white text-3xl border-4 border-white dark:border-gray-800">
                {profile.name.charAt(0).toUpperCase()}
              </div>
            )}
          </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="dark:text-white">{formatDate(profile.joinDate)}</p>
          </div>
          
          {profile.denomination && (
            <div>
              <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Denomination</h3>
              <p className="dark:text-white">{profile.denomination}</p>
            </div>
          )}
        </div>
        ...
        {profile.socialLinks && Object.values(profile.socialLinks).some(link => !!link) && (
          <div className="mt-4">
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Connect</h3>
