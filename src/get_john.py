...
john = next(book for book in data if book['abbrev'] == 'jn')

# Print the number of chapters
print(f'Number of chapters in John: {len(john["chapters"])}')

# Print John 8:1-12 if available
if len(john['chapters']) >= 8:
